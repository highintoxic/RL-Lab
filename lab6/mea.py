...
for eps_delta in eps_delta_pairs : 
	...
	while k_l!=1 : 
		...
		s3.append(time.perf_counter()-start3)
...
print ('Total time taken (over all eps-delta pairs): ',time.perf_counter()-start,'\n\n')
